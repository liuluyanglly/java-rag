...
public class ResearchController {
    ...
    @Data
    @Schema(name = "SubmitTopicRequest", description = "深度研究课题提交入参")
    public static class SubmitTopicRequest {

        @Schema(description = "研究课题，建议为一句完整的研究问题",
                example = "国内企业级 RAG 平台的技术选型与落地路径",
    ...
    @PostMapping("/submit")
    public Result<AiResearchTask> submit(@RequestBody SubmitTopicRequest req) {
    ...
    @GetMapping("/tasks")
    public Result<List<AiResearchTask>> getTasks() {
        Long userId = StpUtil.isLogin() ? StpUtil.getLoginIdAsLong() : 1L;
