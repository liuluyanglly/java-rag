...
public class DeepResearchService {
    ...
    public List<AiResearchTask> getUserTasks(Long userId) {
        return taskMapper.selectList(new LambdaQueryWrapper<AiResearchTask>()
                .eq(AiResearchTask::getUserId, userId)
                .orderByDesc(AiResearchTask::getCreateTime));
    }

    public AiResearchTask getTaskByTaskId(String taskId) {
        return taskMapper.selectOne(new LambdaQueryWrapper<AiResearchTask>()
